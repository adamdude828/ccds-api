...
class TranscodePosterVideoJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $meta['output']['poster-job-name'] = $meta['input']['guid'] . "POSTER-JOB";

            $this->video->meta = $meta;
            $this->video->save();
